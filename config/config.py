...
_pre.add_argument("--ingest",    default=None)        #future release
_pre.add_argument("--force",     action="store_true") #future release
_pre.add_argument("--reload",    action="store_true") #future release
...
os.environ.setdefault("LLM_MODEL",       "models/Qwen3-8B")
os.environ.setdefault("EMBED_MODEL",     "models/nomic-embed-text-v1.5")
...
LLM_MODEL       = os.getenv("LLM_MODEL", "models/Qwen3-8B").strip()
EMBED_MODEL     = os.getenv("EMBED_MODEL", "models/nomic-embed-text-v1.5").strip()
