...
# Note appended to all unconditional-bypass tool outputs
BYPASS_NOTE = (
    #"\n\n---\n"
    #"*⚡ This result was returned without LLM synthesis, "
    #"preserving full detail and reducing response latency. "
    #"The output above is the complete, unmodified tool response.*"
    ""
)
...
LIST_INTENTS = (
    ...
    r"\ball log\b", r"\ball events\b", r"\beverything\b",
    r"\blist entire\b", r"\bshow entire\b", r"\bget entire\b", r"\bdisplay entire\b",
    r"\bdescribe pod\b", r"\bdescribe pvc\b", r"\bdescribe pv\b", r"\bdescribe sc\b",
    r"\bdescribe persistent volume claim\b", r"\bdescribe persistent volume\b", r"\bdescribe storage class\b",
)

ALWAYS_SYNTHESISE = (
    r"\bwhy\b", r"\bhow\b", r"\bwhen\b", r"\bwhere\b", r"\bwho\b", r"\bwhich\b",
    r"\bis there\b", r"\bare there\b", r"\bis any\b", r"\bare any\b",
    r"\bdoes any\b", r"\bdo any\b", r"\bmatch any\b",
)
